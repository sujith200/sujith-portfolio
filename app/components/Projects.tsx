...
const featuredProjects: Project[] = [
  {
    id: 1,
    title: "Smart Campus – Lost & Found Management System",
    description: "A full-stack campus platform that helps students report, search, and recover lost items through an intelligent matching system. The application includes authentication, image uploads, notifications, and an admin dashboard.",
  ...
  {
    id: 3,
    title: "Mens Fashion E–commerce Website",
    description: "A modern e-commerce platform for men's fashion, featuring a sleek design, intuitive navigation, and a seamless shopping experience.",
